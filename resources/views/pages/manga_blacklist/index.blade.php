...
<div class="pcoded-main-container">
    <div class="pcoded-content">
        <h5 class="mb-3">Blacklist Manga</h5>
                                                    ...
                                                    <div class="modal-dialog modal-sm">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="exampleModalLabel">Yakin restore?</h5>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('restore', $data->id) }}" method="post">
                                                                    @method('PUT')
                                                                    @csrf
                                                                    <button type="submit" class="btn btn-primary">Ya, restore</button>
                                                                </form>
                                                            </div>
                                                        </div>
                                                    </div>
