    ...
    <div class="pcoded-content">
        <div class="row">
            <div class="col-12 col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('update-title-recommend', $title->id) }}" method="post">
                            @csrf
                            @method('PUT')
            ...
            <div class="col-12 col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h5>Custom Slider {{ $title->rekomendasi }}</h5>
                    </div>
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('slider-recommend.store') }}" method="post">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        <label>Urutan</label>
                                        <input type="number" class="form-control form-control-sm" name="urutan" required>
                                    </div>
                                </div>
                                <div class="col">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-center">
                                            <img src="{{ $recommend->manga->poster }}" class="img-fluid" style="max-height: 50px">
                                        </td>
                                        <td>{{ Str::limit($recommend->manga->title,29) }}</td>
                                        <td class="text-center">{{ $recommend->urutan }}</td>
                                        <td>
                                            <div class="btn-group mb-2 mr-2">
                                                ...
                                                <div class="dropdown-menu">
                                                    <a class="dropdown-item" href="#!" data-toggle="modal"
                                                        data-target="#ubah_{{ $recommend->id }}">Ubah</a>
                                                    <a class="dropdown-item" href="#!" data-toggle="modal"
                                                        data-target="#hapus_{{ $recommend->id }}">Hapus</a>
                                                </div>
                                            </div>
                                            <!-- Modal Ubah -->
                                            <div class="modal fade" id="ubah_{{ $recommend->id }}" tabindex="-1"
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="{{ route('slider-recommend.update', $recommend->id) }}" method="post">
                                                            @csrf
                                                            @method('PUT')
                                                ...
                                                <div class="modal-dialog modal-sm">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary"
                                                                data-dismiss="modal">Batal</button>
                                                            <form action="{{ route('slider-recommend.destroy', $recommend->id) }}"
                                                                method="post">
                                                                @csrf
                                                                @method('DELETE')
