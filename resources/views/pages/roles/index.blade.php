                ...
                <div class="col-12 col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h5>Data Role</h5>
                            <a href="{{ route('roles.create') }}" class="btn btn-success btn-sm float-right">Tambah</a>
                        </div>
                        <div class="card-body">
                                                    ...
                                                    <div class="btn-group mb-2 mr-2">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item"
                                                                href="{{ route('roles.edit', $data->id) }}">Ubah</a>
                                                        ...
                                                        <div class="modal-dialog modal-sm">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <form action="{{ route('roles.destroy', $data->id) }}"
                                                                        method="post">
                                                                        @method('DELETE')
                                                                        @csrf
                                                                        <button type="submit"
