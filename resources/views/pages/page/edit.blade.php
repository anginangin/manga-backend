                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content" class="form-control form-control-sm" cols="30" rows="10" required>{{ $page->content }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" name="status">
                                                <option value="0" {{ $page->status == '0' ? 'selected' : '' }}>Aktif
                                                </option>
                                                <option value="1" {{ $page->status == '1' ? 'selected' : '' }}>Tidak
                                                    Aktif</option>
                                            </select>
                                        </div>
                                    </div>
